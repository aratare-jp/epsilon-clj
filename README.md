...
On the other hand, we have a few code generators that are model-driven, such as JET, [Acceleo](https://www.eclipse.org/acceleo/) and [Epsilon](https://www.eclipse.org/epsilon/). However, they are plagued with major issues such as:
